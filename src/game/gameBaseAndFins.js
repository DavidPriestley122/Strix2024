...
const fin2 = createFin("fin2", -Math.PI / 6, new Vector3(finOffset * Math.cos(Math.PI / 3), 0, -finOffset * Math.sin(Math.PI / 3)));
const fin3 = createFin("fin3", -5 * Math.PI / 6, new Vector3(finOffset * Math.cos(Math.PI / 3), 0, finOffset * Math.sin(Math.PI / 3)));
